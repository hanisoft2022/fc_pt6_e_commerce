...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i903.MenuBloc>(
      () => _i903.MenuBloc(displayUsecase: gh<_i494.DisplayUsecase>()),
    );
    gh.factory<_i670.ViewModuleBloc>(
      () => _i670.ViewModuleBloc(displayUsecase: gh<_i494.DisplayUsecase>()),
    );
    return this;
  }
}
