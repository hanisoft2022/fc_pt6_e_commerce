...
class _DisplayApi implements DisplayApi {
  _DisplayApi(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<ResponseWrapper<List<MenuDto>>> getMenus(String mallType) async {
    ...
    final _options = _setStreamType<ResponseWrapper<List<MenuDto>>>(
  ...
  Future<ResponseWrapper<List<ViewModuleDto>>> getViewModulues(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ResponseWrapper<List<ViewModuleDto>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
