...
class _ViewModuleDto implements ViewModuleDto {
  const _ViewModuleDto({this.type = '', this.title = '', this.subtitle = '', this.imageUrl = '', this.time = -1, final  List<ProductInfoDto> products = const <ProductInfoDto>[], final  List<String> tabs = const <String>[]}): _products = products,_tabs = tabs;
